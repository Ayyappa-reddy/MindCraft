...
export default function ProblemPanel({
  ...
  return (
    <div className="h-full bg-[#f9fafb] border-r border-gray-200 overflow-y-auto">
      <div className="p-6 space-y-6">
        {/* Title */}
        <div>
          <h1 className="text-2xl font-bold text-[#1f2937] mb-2 break-words">
        ...
        <Card className="p-4 bg-white border-gray-200">
          <div className="text-[#1f2937] leading-relaxed break-words">
          ...
          <div className="space-y-2">
            ...
            <AnimatePresence>
              {expandedSections.input && (
                ...
                >
                  <Card className="p-4 bg-white border-gray-200">
                    <p className="text-gray-700 whitespace-pre-wrap break-words">{inputFormat}</p>
                  </Card>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          <div className="space-y-2">
            ...
            <AnimatePresence>
              {expandedSections.output && (
                ...
                >
                  <Card className="p-4 bg-white border-gray-200">
                    <p className="text-gray-700 whitespace-pre-wrap break-words">{outputFormat}</p>
                  </Card>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          <div className="space-y-2">
            ...
            <AnimatePresence>
              {expandedSections.constraints && (
                ...
                >
                  <Card className="p-4 bg-white border-gray-200">
                    <p className="text-gray-700 whitespace-pre-wrap font-mono text-sm break-words">
                      {constraints}
                    </p>
                  </Card>
                </motion.div>
